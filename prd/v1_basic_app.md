...
- **Database**: Postgres via Prisma ORM (adapter-based client, `@prisma/adapter-pg`). Single source of truth. Flexible fields (e.g. menu modifiers) stored as JSONB columns — no separate NoSQL store.
