...
DATABASE_URL_TEST=postgresql://postgres:postgres@localhost:5432/pos_test
...
Run against test DB: add `"pretest": "DATABASE_URL=$DATABASE_URL_TEST prisma migrate deploy"` or simply point `DATABASE_URL` at `pos_test` when running tests (document in README, use `dotenv-cli` or export inline for now):
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/auth-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/menu-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/ingredient-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/table-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/order-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/kitchen-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST npm test -- tests/integration/stock-deduct.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/payment-router.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret npm test -- tests/integration/order-cancel.test.ts`
...
Run: `DATABASE_URL=$DATABASE_URL_TEST JWT_SECRET=test-secret REDIS_URL=redis://localhost:6379 npm test -- tests/integration/report-router.test.ts`
