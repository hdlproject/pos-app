...
// REVEAL_X = 2 * icon's px-4 padding + its w-4 width, so the justify-end
// icon lands centered in the exposed strip instead of hugging the edge.
const REVEAL_X = -48;
...
export function SwipeToRemove({
  ...
  const bgOpacity = useTransform(x, [-24, -6], [1, 0]);
